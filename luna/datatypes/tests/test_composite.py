...
class test_timeDataPoint_TimeSeries(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for i in range(10000):
            ...
            timeDataPoint = DataTimePoint(t = 1000000000 + (i*60), tz="Europe/Rome", data=data, )
            timeSeries.append(timeDataPoint)
    ...
    def test_iterator(self):
        for i, timeDataPoint in enumerate(self.ref_timeSeries_1):
            self.assertEqual(timeDataPoint.t, 1000000000 + (i*60))  
    ...
    def test_append_consistency(self):
        ...
        timeDataPoint1=DataTimePoint(t=60, data=data1, tz="Europe/Rome")
        timeDataPoint2=DataTimePoint(t=120, data=data2, tz="UTC")
        timeDataPoint3=DataTimePoint(t=180, data=data3, tz="Europe/Rome")
        timeSeries=TimeSeries()
        timeSeries.append(timeDataPoint1)
        
        with self.assertRaises(InputException):
            timeSeries.append(timeDataPoint2)
        
        with self.assertRaises(InputException):
            timeSeries.append(timeDataPoint3)
    ...
    def test_one(self):
        ...
        for i in range(10):
            ...
            timeDataSlot = DataTimeSlot(start = TimePoint(t = 1000000020 + (i*60), tz="Europe/Rome"),
                                        ...
                                        data  = data, type=TimeSlotType("1m"))
